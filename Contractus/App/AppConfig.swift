...
enum AppConfig {
    ...
    static let serverType: ServerType = .custom(api: URL(string: "http://localhost:3000/v1")!, ws:  URL(string: "ws://localhost:3001")!)
    //ConfigStorage.getServer(defaultServer: .developer())
