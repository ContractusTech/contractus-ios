...
final class ContractusAPITests: XCTestCase {
    func testCurrencyFormatToString() throws {
        ...
        XCTAssertEqual(Currency(code: "USDC", name: "USD Coin", decimal: 6).format(amount: 1000000001), "USDC 1,000.000001")
    ...
    func testCurrencyFormatToInt() throws {
        XCTAssertEqual(Currency(code: "USDC", name: "USD Coin", decimal: 6).format(string: "1,000.000001"), 1000000001)
        ...
        let amount = Currency(code: "USDC", name: "USD Coin", decimal: 6).format(string: "1,000.0000010000")
        XCTAssertEqual(Currency(code: "USDC", name: "USD Coin", decimal: 6).format(amount: amount!), "USDC 1,000.000001")
    }
}
